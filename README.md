...
**Focus:** Full-Stack (React + Django) · Clean Code · CI/CD · Docker · Game Dev · Media Design  
...
## 🧍‍♂️ About me / Sobre mí
- 🎓 Egresado de **Ingeniería de Sistemas**, apasionado por construir software útil, escalable y con buena experiencia de usuario.  
...
- 🎮 Interesado también en **desarrollo de videojuegos (Unity)** y **creación audiovisual (Adobe Suite)**.  
...
| **Database** | PostgreSQL, SQL basics, Pandas |
| **Infra / DevOps** | Docker, GitHub Actions, Vercel, Render |
| **Testing** | Pytest, React Testing Library |
| **Media / Game** | Unity, After Effects, Illustrator, Photoshop |

---

## 🧮 Codewars & Stats
<p align="center">
  <img src="https://www.codewars.com/users/DiegoCarlosRojasApaza/badges/large" alt="Codewars badge" />
</p>

> [🌐 Ver perfil en Codewars](https://www.codewars.com/users/DiegoCarlosRojasApaza)  
> Rank: **6 kyu** · 146 honor points · Languages: *Python, JavaScript, SQL*
